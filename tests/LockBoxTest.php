...
class LockBoxTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testSetItemWithObject()
    {
        ...
        $this->assertInstanceOf('Container\Tests\Fixtures\Service', $lockbox->get('item'));
    }
    ...
    /**
     * @expectedException \Container\Exception\ItemNotFoundException
